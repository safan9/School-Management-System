...
<section class="login-area">
	<div class="container">
		<div class="row">
			...
			<br/>
			<!-- 
				** Fetching Study Material from database for student **
			-->
			<?php
						...
						<?php  
							if(mysqli_num_rows($result) > 0){
								while($file = mysqli_fetch_assoc($result)){
									?>
										<div class='col-md-3'>
											<a href="<?php echo "Staff/vendor/".$file['file']; ?>" download>
												<i class="fa fa-file-pdf-o fa-5x"></i>
											</a>
												<div class="caption">
													<p>
														<b>File Name:</b><?php echo $file['file_name']; ?><br/>
														<b>Subject:</b><?php echo $file['subject_name']; ?><br/>
														<b>Class:</b><?php echo $file['class_name']; ?>
													</p>
												</div>
										</div>
									<?php
