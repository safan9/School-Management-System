			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Feedback</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Feedback</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
		...
		<div class="row">
			...
			<div class="container">
				<form name="feedback-form" method="POST"> 
					...
					<div class="form-group row">
						<div id="errorMsg" class="col-md-8"></div>
					</div>
					<div class="form-actions">
						<div class="row">
							<div class="offset-md-3 col-md-9 text-center">
								<input type="submit" id="btn-send" name="btn-send" class="btn btn-info m-r-20" value="Send">
			...
			<?php
				...
				if(mysqli_num_rows($res) > 0){
					while($feedback = mysqli_fetch_assoc($res)){
						?>
							<div class='well'>
								<img class='img-responsive img-circle' width="50" height="50" 
									src="<?php echo 'vendor/'.$feedback['photo']; ?>" />
								<div class="">
