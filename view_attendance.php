			...
			<div class="container">
				...
				<div class="collapse navbar-collapse edu-nav main-menu" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav pull-right">
                        ...
                        <li class="active"><a href="view_attendance.php"> Attendance</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Attendance</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> My Attendance</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
