			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Gallery</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Image Uploads</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
...
<section class="login-area">
	<div class="container">
		<div class="row">
			...
			<hr/>
			<div class="row">
				<form name='image_upload_from' method='POST' action='vendor/uploadImage.php' enctype="multipart/form-data">
					<label class='col-md-2'>Select Image:</label>
					<input class="col-md-6 form-control" type="file" name="image-upload" id="image-upload" accept="image/*" />
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".btn_delete").click(function(e){
			...
			if(confirmation){
				location.href = "vendor/delete_image.php?id="+image_id;
			}
		});
	});
</script>
