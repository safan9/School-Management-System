				...
				<ul id="themecolors">
					...
					<li class="complete">
						<div class="theme-color layout-theme">
							<a href="http://radixtouch.in/templates/admin/smart/source/light/fees_receipt.html" data-theme="light"><span class="head"></span><span class="cont"></span></a>
						 ...
						 data-slide-speed="200" style="padding-top: 20px">
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									...
									<li class="nav-item">
										<a href="student_profile.page-header-option" class="nav-link "> <span class="title">About Student</span>
										</a>
									</li>
								</ul>
							</li>
