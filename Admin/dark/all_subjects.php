				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Subjects List</div>
							</div>
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="add_subject.php" id="addRow" class="btn btn-info">
																...
																<tbody>
																	...
																	if(mysqli_num_rows($result) > 0){
																		while($row = mysqli_fetch_assoc($result)){
																			...
																			<td>
																				<a href="edit_subject.php?id=<?php echo $row["subject_id"]; ?>" class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																				</a>
																				<a data-id="<?php echo $row["subject_id"]; ?>" class="btn btn-danger btn-xs btn_delete">
			...
			<script type="text/javascript">
				$('document').ready(function(){
					$(".btn_delete").click(function(e){
						...
						if(confirmation){
							location.href = "scripts/delete_subject.php?id="+subject_id;
						}
					});
				});
			</script>
