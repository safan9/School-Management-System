<?php
	...
	$division_id = $_GET["id"];
	//getting records from table for given division_id.
	$sql = "SELECT * FROM division_mst WHERE division_id='$division_id'";
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Division</div>
							</div>
					...
					<div class="card-body">
						...
						<form action="scripts/updateDivision.php?id=<?php echo $row['division_id']; ?>" method="POST" onsubmit="return validate_division()" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
							<div class="form-body">
								<div class="form-group row">
									...
									<div class="col-md-5">
										<input type="text" name="division_name" id="division_name" placeholder="enter division name" class="form-control input-height" value="<?php echo $row['division_name']; ?>" />
								...
								<div class="form-actions">
									<div class="row">
										<div class="offset-md-3 col-md-9">
											<input type="submit" id="btn-submit" name="btn-division-submit" class="btn btn-info m-r-20" value="Update">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					function check_room_no(){
						var room_no_length = $("#room_no").val().length;
