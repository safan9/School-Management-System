	...
	if($month_id != '0'){
		...
		$output = "
					<table class='table table-bordered'>
						<thead>
							<tr>
								<td colspan='5' class='text-center bg-primary'>IQRA HIGHER SECONDARY SCHOOL</td>
							</tr>
							<tr>
								<td colspan='5' class='text-center'>MONTHLY ATTENDANCE REPORT</td>
							</tr>
							<tr>
								<th>Class Name:</th>
		...
		$output .= "
					...
					<a href='../attendance_report.php' class='btn btn-warning'>Go Back</a>
					<a href='excel_attendance.php?month=$month_id&year=$academic_year_id&div_id=$div_id&name=$staff_name' class='btn btn-success'>Export To MS-EXCEL</a>
				";
