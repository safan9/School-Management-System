<?php
	...
	$subject_id = $_GET["id"];
	//getting records from table for given subject_id.
	$sql = "
			SELECT subject_mst . * , staff_mst.first_name, class_mst.class_name
			FROM subject_mst
			INNER JOIN staff_mst ON subject_mst.staff_id = staff_mst.staff_id
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="home.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="card-body">
						...
						<form action="scripts/updateSubject.php?id=<?php echo $subject_id; ?>" method="POST" onsubmit="return validate_subject()" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
							<div class="form-body">
								<div class="form-group row">
									...
									<div class="col-md-5">
										<input type="text" name="subject_name" id="subject_name" placeholder="enter subject name" 
											   class="form-control input-height" value="<?php echo $subject['subject_name']; ?>" />
											...
											<?php
												...
												if(mysqli_num_rows($result) > 0){
													while($row = mysqli_fetch_assoc($result)){
														if($row['staff_id'] == $subject['staff_id'])
														{
														?>

															<option value="<?php echo $row['staff_id']; ?>" selected>
