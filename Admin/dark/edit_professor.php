...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme">
	<div class="page-wrapper">
		...
		?>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								...
								<div class="card-body" id="bar-parent">
									<form action="scripts/updateStaff.php?id=<?php echo $_GET["id"]; ?>" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="first_name" id="first_name" placeholder="enter first name" class="form-control input-height" value=<?php echo $row["first_name"]; ?> >
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="middle_name" id="middle_name" placeholder="enter middle name" class="form-control input-height" value=<?php echo $row["middle_name"]; ?> >
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="designation" id="designation" placeholder="enter designation" class="form-control input-height" value=<?php echo mysql_escape_string($row["designation"]); ?>>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="qualification" id="qualification" placeholder="enter qualification" class="form-control input-height" value=<?php echo mysql_escape_string($row["qualification"]); ?> >
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="experience" id="experience" placeholder="enter experience" class="form-control input-height" value=<?php echo mysql_escape_string($row["past_experience"]); ?>>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="address" name="address" id="address" placeholder="address" class="form-control input-height"
														value=<?php echo mysql_escape_string($row["address"]); ?>>
			...
			<!-- Form Validation Starts for add professor-->
				<script>
					$(document).ready(function(){
						...
						$("#btn-submit").click(function(){
							...
							if(errFname == false && errMname == false && errLname == false && errDesignation == false && errQualification == false && errExperience == false && errAddress == false && errMobile_no == false && errEmail == false && errSalary == false){
								return true;
							}else{
								return false;
							}
