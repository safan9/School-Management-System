		...
		?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">All Classes List</div>
							</div>
									...
									if(mysqli_num_rows($result) > 0){
										while($row = mysqli_fetch_assoc($result)){
											?>
													...
													<div class="card-body">
													<div class="panel panel-info col-xs-4">
									  				...
									  				<div class="panel-heading bg-info">
									  					...
									  					<a class="btn btn-danger btn-xs pull-right btn_delete_class" data-id="<?php echo $row['class_id']; ?>">
									  						<i class="fa fa-trash-o"></i>
									  					</a>
									  					&nbsp;
									  					<a href="edit_class.php?id=<?php echo $row
   											 							["class_id"]; ?>" class="btn btn-default btn-xs pull-right">
															<i class="fa fa-pencil"></i>
														</a>
									  				</div>
  												<div class="panel-body">
   											 		<div><i class="fa fa-arrow-right"></i><b><u><i>Divisions:</i></u></b></div>
   											 		<?php
   											 			...
   											 			if(mysqli_num_rows($res) > 0){
   											 				while($div = mysqli_fetch_assoc($res)){
   											 					?>
   											 						<div><b>Division Name: </b><?php echo $div['division_name']; ?></div>
   											 						<div><b>Class Incharge: </b><?php echo $div['first_name']; ?></div>
   											 						<div>
			...
			<script type="text/javascript">
				$('document').ready(function(){
					...
					$(".btn_delete_class").click(function(e){
						e.preventDefault();
						var class_id = $(this).attr('data-id');
						var confirmation = false;
						confirmation = confirm("Are You Sure You Want To Delete This Class?");
						if(confirmation){
							location.href = "scripts/delete_class.php?id="+class_id;
						}
					});
				});
			</script>
