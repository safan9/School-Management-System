																	...
																	if(mysqli_num_rows($result) > 0){
																		while($row = mysqli_fetch_assoc($result)){
																			?>
																				...
																				<img src="scripts/<?php echo $row['photo']; ?>" alt="">
																				</td>
																				<td>
																			...
																			<td>
																				<a href="edit_professor.php?id=<?php echo $row["staff_id"]; ?>" class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																				</a>
																				<a data-id="<?php echo $row["staff_id"]; ?>" class="btn btn-danger btn-xs btn_delete">
																			...
																			<td class="center">
																				<?php
																					...
																					{
																						?>
																							<a href="scripts/active_staff.php?id=<?php echo $row["staff_id"]; ?>" class="btn btn-primary btn-xs">
																						...
																						?>
																							<a href="scripts/deactive_staff.php?id=<?php echo $row["staff_id"]; ?>" class="btn btn-warning btn-xs">
			...
			<script type="text/javascript">
				$('document').ready(function(){
					$(".btn_delete").click(function(e){
						...
						if(confirmation){
							location.href = "scripts/delete_staff.php?id="+staff_id;
						}
					});
				});
			</script>
