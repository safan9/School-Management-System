				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Image Upload</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="home.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Image Upload</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="card-body">
						<div class="row">
							<form name='image_upload_from' method='POST' action='scripts/uploadImage.php' enctype="multipart/form-data">
								<label>Select Image:</label>
								<input class=" form-control" type="file" name="image-upload" id="image-upload" accept="image/*" />

								<div class="form-actions">
									<input type="submit" name="btn-upload" id="btn-upload" value="Upload" class="btn btn-primary" />
									<input type="reset" name="btn-upload" id="btn-upload" value="Reset" class="btn btn-default" />
								</div>
								<div>
									<?php 
									
										if($_SESSION['image_status'] != ''){
											echo "<div class='well bg-warning text-danger col-md-6'>";
						...
						<?php  
							...
							<table class="table table-bordered">
								...
								while($image = mysqli_fetch_assoc($result)){
									...
									<tr>
										<td>
											<img src="<?php echo '../../vendor/'.$image['image'];?>" width="50" height="50">
										</td>
										<td>
		...
		<script type="text/javascript">
				$(document).ready(function(){
					$(".btn_delete").click(function(e){
						...
						if(confirmation){
							location.href = "scripts/delete_admin_image.php?id="+image_id;
						}
					});
				});
			</script>
