			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Study Corner</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Study Corner</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
...
<section class="login-area">
	<div class="container">
		<div class="row">
			...
			<form name="homework_form" method="POST" action="vendor/upload_homework.php" enctype="multipart/form-data">
				<div class="row">
					<label>Select Homework File(PDF):</label>
					<div class="form-group">
						<input type="file" name="homework_file" class="form-control" accept="application/pdf" />
					</div>
					<?php
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".btn_delete").click(function(e){
			...
			if(confirmation){
				location.href = "vendor/delete_homework.php?id="+image_id;
			}
		});
	});
</script>
