<?php
	...
	if($academic_year_id != '0'){
		...
		if(mysqli_num_rows($result) > 0){
			...
			$sql = "
				SELECT fees_mst.*, division_mst.division_name, month_mst.month_name, student_mst.*, academin_year_mst.* 
				FROM fees_mst
			...
			if(mysqli_num_rows($res) > 0){
				...
				$output .= "
					...
					<a class='btn btn-primary' href='vendor/download_attendance_report.php?year=$academic_year_id'>Print Preview</a>
				";
			}else{
