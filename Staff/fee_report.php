			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Reports</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Feee Report</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
		...
		<div class="row">
			...
			<form name="fee_report_form" action="#" method="POST">
				<div class="from-body">
					...
					<div class="form-group row" id="Fee_Area">
...
<script type="text/javascript">
	$(document).ready(function(){
					...
					$("#academic_years").change(function(){
						...
						$.ajax({
							url: "vendor/fetchFee_report.php",
							type: "POST",
