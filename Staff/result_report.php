			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Reports</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Result Report</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
...
<section class="login-area">
	<div class="container">
		...
		<div class="row">
			...
			<h3>Result Report: </h3>
			<form name="fee_report_form" action="#" method="POST">
				<div class="from-body">
					...
					<div class="form-group row" id="Result_Area">
...
<script type="text/javascript">
	$(document).ready(function(){
					...
					$("#subjects").change(function(){
						...
						var subject_id = $("#subjects").find(":selected").val();
						$.ajax({
							url: "vendor/fetchResult_report.php",
							type: "POST",
