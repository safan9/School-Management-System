			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Fees</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Add Fees</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
...
<section class="login-area">
	<div class="container">
		<div class="row">
			<h3>Add Fees</h3>
			<form name="add_result_form" action="vendor/addFees.php" method="POST">
				<div class="from-body">
					...
					<div class="form-group row" id="fees_area">
					...
					<div class="form-actions">
						<div class="row">
							<div class="offset-md-3 col-md-9 text-center">
								<input type="submit" id="btn-add" name="btn-add" class="btn btn-info m-r-20" value="Add Fees">
...
<script type="text/javascript">
				$(document).ready(function(){
					...
					$("#students").change(function(){
						...
						$.ajax({
							url: "vendor/check_fees_info.php",
							type: "POST",
