			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Result</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> View Result</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
		...
		<div class="row">
			...
			<form name="add_result_form" action="vendor/addResult.php" method="POST">
				<div class="from-body">
					...
					<div class="form-group row" id="subjects" style="background: white">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#subjects").on('click', '.btn_delete', function(e){
					e.preventDefault();
					//alert('delete');
					...
					if(confirmation){
						location.href = "vendor/delete_result.php?id="+student_id;
					}
		});
	});
