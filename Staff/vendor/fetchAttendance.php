	...
	if($student_id != '0'){
		...
		if(mysqli_num_rows($result) > 0){
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td colspan='2' class='text-center'>
							<a href='edit_attendance.php?id=$attendance_id' name='btn_edit' id='btn_edit' class='btn btn-primary'>
								Edit
							</a> 
							<a data-id='$attendance_id' id='btn_delete' name='btn_delete' class='btn btn-danger btn_delete'>Delete</a>
						</td>
					</tr>
					</table>
					";	
			...
			$output .= "
				...
				<a href='add_attendance.php' class='btn btn-primary'>Add Now</a>
			";
		}
