			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Attendance</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Add Attendance</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
					...
					<div class="form-actions">
						<div class="row">
							<div class="offset-md-3 col-md-9 text-center">
								<input type="submit" id="btn-add" name="btn-add" class="btn btn-info m-r-20" value="Add Attendance">
...
<script type="text/javascript">
				$(document).ready(function(){
					...
					$("#months").change(function(){
						...
						$.ajax({
							url: "vendor/check_attendance_info.php",
							type: "POST",
