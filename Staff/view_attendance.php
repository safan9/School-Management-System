			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Attendance</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> View Attendance</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
...
<section class="login-area">
	<div class="container">
		<div class="row">
			...
			<form name="add_attendance_form" action="vendor/addAttendance.php" method="POST">
				<div class="from-body">
					...
					<div class="form-group row" id="add_attendance">
...
<script type="text/javascript">
	$(document).ready(function(){
					...
					$("#months").change(function(){
						...
						$.ajax({
							url: "vendor/fetchAttendance.php",
							type: "POST",
							data: {	student_id: student_id,
									month_id: month_id },
							success: function(data){
								$("#add_attendance").html(data);
								$("#add_attendance").show();
							}
						});
					});
					...
					$("#add_attendance").on('click', '.btn_delete', function(e){
						e.preventDefault();
						//alert('delete');
						var attendace_id = $(this).attr('data-id');
						var confirmation = false;
						confirmation = confirm("Are You Sure You Want To Delete This Record?");
						if(confirmation){
							location.href = "vendor/delete_attendance.php?id="+attendace_id;
						}
					});
