	...
	if($student_id != '0'){
		...
		if(mysqli_num_rows($result) > 0){
			...
			$output .= "<tr>
				...
				<a href='download_result.php' class='btn btn-primary' name='btn-print'>Print Preview</a>
				";
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse edu-nav main-menu" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav pull-right">
                        ...
                        <li class="active"><a href="view_result.php">My Result</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Result</h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> My Result</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
